  ...
  const NavItem = ({ item }) => {
    ...
    return (
      <button
        ...
        className={`group relative mb-[2px] flex w-full items-center gap-[10px] rounded-[11px] px-[11px] py-[9px] text-left text-[13px] font-medium transition-all duration-200 decoration-none ${
          isActive
      ...
      >
        ...
        <span
          className={`flex h-[28px] w-[28px] shrink-0 items-center justify-center rounded-[8px] transition-all duration-200 ${
            isActive
  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 z-[300] hidden w-[260px] flex-col border-r-[1.5px] border-indigo-300/20 bg-white/90 shadow-[4px_0_36px_rgba(79,70,229,0.07)] backdrop-blur-[28px] lg:flex">
      ...
      <div className="flex items-center gap-[10px] border-t border-indigo-300/20 px-[14px] py-[13px]">
        ...
        <span className="ml-auto cursor-pointer text-[16px] text-slate-400">⋯</span>
      </div>
    </aside>
  );
}
