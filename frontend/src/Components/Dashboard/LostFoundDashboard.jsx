...
export const Sidebar = ({ counts, onFilterChange, activeFilter, activeTab, onTabChange }) => {
  ...
  return (
    <aside className="fixed top-0 left-0 bottom-0 w-[220px] bg-white border-r border-gray-200 flex flex-col z-[300] hidden lg:flex shadow-sm">
      {/* Logo */}
      <div className="flex items-center gap-[12px] py-[22px] px-[20px]">
        <div className="flex items-center justify-center w-[34px] h-[34px] bg-[#4f46e5] rounded-[10px]">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>
        </div>
        <span className="text-[19px] font-bold text-[#1e1b4b]">UniVault</span>
      </div>
